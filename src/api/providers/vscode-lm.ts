			...
			for await (const chunk of response.stream) {
				if (chunk instanceof vscode.LanguageModelTextPart) {
					...
					if (typeof chunk.value !== "string") {
						console.warn(
							"Datacoves Copilot <Language Model API>: Invalid text part value received:",
							chunk.value,
						)
						continue
					}
					...
					try {
						...
						if (!chunk.name || typeof chunk.name !== "string") {
							console.warn(
								"Datacoves Copilot <Language Model API>: Invalid tool name received:",
								chunk.name,
							)
							continue
						}
						...
						if (!chunk.callId || typeof chunk.callId !== "string") {
							console.warn(
								"Datacoves Copilot <Language Model API>: Invalid tool callId received:",
								chunk.callId,
							)
							continue
						}
						...
						if (!chunk.input || typeof chunk.input !== "object") {
							console.warn(
								"Datacoves Copilot <Language Model API>: Invalid tool input received:",
								chunk.input,
							)
							continue
						}
