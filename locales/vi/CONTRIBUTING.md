...
# Đóng góp cho Datacoves Copilot

Datacoves Copilot là một dự án do cộng đồng dẫn dắt và chúng mình rất trân trọng mọi đóng góp. Để đơn giản hóa quy trình hợp tác, chúng mình áp dụng cách tiếp cận [Issue-First](#cách-tiếp-cận-issue-first), nghĩa là tất cả [Pull Request (PR)](#gửi-pull-request) phải được liên kết với một GitHub Issue trước. Vui lòng đọc kỹ hướng dẫn này.
...
### 3. Tham gia cộng đồng Datacoves Copilot
...
- Về tài liệu, hãy xem [Datacoves Copilot Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
Khi gửi pull request, bạn đồng ý rằng đóng góp của mình sẽ được cấp phép theo Giấy phép Apache 2.0, phù hợp với giấy phép của Datacoves Copilot.
