 ...
 *
 * This class manages the state for the marketplace view in the Datacoves Copilot extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Datacoves Copilot extensions interface
