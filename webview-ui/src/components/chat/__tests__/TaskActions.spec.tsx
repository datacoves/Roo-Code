	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"chat:task.connectToCloudDescription": "Sign in to Datacoves Copilot Cloud to share tasks",
				"chat:task.sharingDisabledByOrganization": "Sharing disabled by organization",
				"account:cloudBenefitsTitle": "Connect to Datacoves Copilot Cloud",
				"account:cloudBenefitsSubtitle": "Sign in to Datacoves Copilot Cloud to share tasks",
...
describe("TaskActions", () => {
	...
	describe("Unauthenticated User Login Flow", () => {
		...
		it("shows connect to cloud option when not authenticated", () => {
			...
			expect(screen.getByText("Connect to Datacoves Copilot Cloud")).toBeInTheDocument()
			expect(screen.getByText("Sign in to Datacoves Copilot Cloud to share tasks")).toBeInTheDocument()
