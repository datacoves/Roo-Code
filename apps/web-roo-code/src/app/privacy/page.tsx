...
export const metadata: Metadata = {
	title: "Privacy Policy - Datacoves Copilot",
	description:
		"Privacy policy for Datacoves Copilot Cloud and marketing website. Learn how we handle your data and protect your privacy.",
}
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Datacoves Copilot Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: June 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how Datacoves Copilot, Inc. (&quot;Datacoves Copilot,&quot;
					...
					<ul className="lead">
						...
						<li>
							create an account for, sign in to, or otherwise use <strong>Datacoves Copilot Cloud</strong>{" "}
							at <strong>app.roocode.com</strong> or through the Datacoves Copilot extension while
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the Datacoves Copilot extension <strong>without</strong> connecting to a Cloud
							...
							<a
								...
								Datacoves Copilot Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>Your source code never transits Datacoves Copilot servers.</strong> It stays on your
							device and is sent <strong>directly</strong>—via a client‑to‑provider TLS connection—to the
							third‑party AI model you select. Datacoves Copilot never stores, inspects, or trains on your
							code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in Datacoves Copilot
							Cloud so you can search and re‑use past conversations. Organization admins can disable this
							collection at any time.
						</li>
						<li>
							We collect only the data needed to operate Datacoves Copilot Cloud, do <strong>not</strong>{" "}
					...
					<ul>
						<li>
							<strong>Operate & secure Datacoves Copilot Cloud</strong> (authentication, completions,
							abuse prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Datacoves Copilot servers; ad networks; model‑training pipelines
									</td>
								</tr>
								<tr className="bg-muted/25">
									<td className="border border-border px-4 py-2 font-medium">
									...
									<td className="border border-border px-4 py-2">
										Datacoves Copilot Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Datacoves Copilot servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on Datacoves Copilot servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside Datacoves Copilot Cloud.
						</li>
					</ul>
