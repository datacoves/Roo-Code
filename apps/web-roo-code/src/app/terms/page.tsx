...
export const metadata: Metadata = {
	title: "Terms of Service - Datacoves Copilot",
	description:
		"Terms of Service for Datacoves Copilot Cloud. Learn about our service terms, commercial conditions, and legal framework.",
}
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Datacoves Copilot Cloud Terms of Service
					</h1>
					...
					<ul className="lead">
						<li>
							...
							executed by Datacoves Copilot and the customer that references these TOS;{" "}
							<strong>and</strong>
						</li>
						<li>
							<strong>(b)</strong> any{" "}
					...
					<p>
						If Datacoves Copilot and Customer later execute a Master Subscription Agreement (&quot;
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										Datacoves Copilot maintains commercially reasonable administrative, physical,
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Datacoves Copilot <strong>does not</strong> use Customer Content to train,
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Datacoves Copilot may identify Customer (name & logo) in marketing materials
					...
					<ol>
						...
						<li>
							...
							<br />
							Deleted – Datacoves Copilot offers no trials, pilots, betas, or SLA credits under these TOS.
						</li>
						<li>
					...
					<p>
						Datacoves Copilot&apos;s Privacy Notice (
						<a
						...
						) explains how Datacoves Copilot collects and handles personal information. If Customer requires
						a DPA, email{" "}
					...
					<ol>
						<li>
							...
							<br />
							Customer may not assign the Agreement without Datacoves Copilot&apos;s prior written
						...
						<li>
							...
							<br />
							Datacoves Copilot may update these TOS by posting a revised version at the same URL and
					...
					<p>
						<strong>Datacoves Copilot, Inc.</strong>
						<br />
