...
suite.skip("Datacoves Copilot use_mcp_tool Tool", function () {
	...
	test("Should request MCP filesystem read_file tool and complete successfully", async function () {
		...
		await sleep(2000) // Wait for Datacoves Copilot to fully initialize
		...
		try {
			...
			// Make a small modification to trigger the save event, without this Datacoves Copilot won't load the MCP server
