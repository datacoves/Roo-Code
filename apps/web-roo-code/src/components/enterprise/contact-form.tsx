...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping Datacoves Copilot's enterprise solution."
			: "Fill out the form below to see Datacoves Copilot's enterprise capabilities in action."
