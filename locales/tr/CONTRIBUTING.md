...
### 3. Datacoves Copilot Topluluğuna Katıl
...
- Dokümantasyon için [Datacoves Copilot Docs](https://github.com/RooCodeInc/Roo-Code-Docs)'u ziyaret et.
...
Pull request göndererek, katkılarının Datacoves Copilot'un lisanslamasıyla tutarlı olarak Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursun.
